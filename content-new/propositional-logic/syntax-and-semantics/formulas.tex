...
% CHANGES: use \PVarP, \PVarQ, \PVarR, \PVarS, for object language
% propositional variables, to allow usr customization
...
\begin{enumerate}
\item !!^a{denumerable} set~$\PVar$ of !!{propositional variable}s $\Obj \PVarP_0$,
  $\Obj \PVarP_1$, \dots
...
\item Every !!{propositional variable}~$\Obj \PVarP_i$ is an atomic
  !!{formula}.
