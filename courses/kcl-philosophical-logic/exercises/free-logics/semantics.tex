...
\item $\forall x(E!x)$
\item $Fa\rightarrow E!a$.
\item $\sim a=b\rightarrow\sim E!a$.
\item $\sim E!a\rightarrow\sim a=b$.
\item $\forall xGxb\rightarrow(E!a\rightarrow Gab)$.
\item $a=b\rightarrow(Fa\rightarrow Fb)$.
\item $E!a\land\sim E!b\rightarrow\sim Gab$.
\end{enumerate}
\end{prob}
