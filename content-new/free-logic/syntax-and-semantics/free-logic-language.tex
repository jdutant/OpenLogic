...
The following is a rigorous definition of the language of free logic.
It is language of first-order logic, with additions
for a primitive $\lfrexists$ predicate.
