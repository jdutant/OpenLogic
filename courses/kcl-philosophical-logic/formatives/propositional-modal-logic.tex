...
\begin{prob}
 ...
 Say whether the formulas below are true in the model (i.e., true at
    ...
    \item $\Box(\Diamond \Obj{\Obj{\pvar{R}}}\lor\Diamond \Obj{\pvar{P}})$
...
\item $\Box(\Diamond \Obj{\pvar{\Obj{\pvar{R}}}}\lor\Diamond \Obj{\pvar{P}})$. True. 
...
\begin{prob}
    ...
    \begin{enumerate}
        ...
        \emph{valid} ($\Entails$). However, because our proof system is
        sound for our semantics, if the argument is provable in it
        then it is valid.
        ...
        make $\Diamond\lnot\Obj{\pvar{A}}$ true) and $\Obj{\pvar{A}}$
