...
\begin{prop}\ollabel{prop:Fa-doesnt-entail-ExFx}
  For some \Log{PFL} !!{structure} $\Struct{M}$, $\Sat{M}{Fa}$ and $\Sat/{M}{\lfrexists a}$.
\end{prop}
...
\begin{prob}
  Prove \olref[frl][syn][pfl]{prop:Fa-doesnt-entail-ExFx}
\end{prob}

\begin{prop}\ollabel{prop:identity-doesnt-entail-existence}
$\Entails/_{\Log{PFL}} \eq[a][a]\lif\lfrexists a$.
\end{prop}
...
\begin{prob}
  Prove \olref[frl][syn][pfl]{prop:identity-doesnt-entail-existence}
\end{prob}

\begin{prop}\ollabel{prop:pfl-is-inclusive}
...
\begin{prob}
  Prove \olref[frl][syn][pfl]{prop:pfl-is-inclusive}
\end{prob}
