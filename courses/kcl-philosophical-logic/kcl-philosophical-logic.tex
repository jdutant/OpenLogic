...
\olimport[philosophical-introduction]{philosophical-introduction}
...
% Replacing the original, didn't work with our notation set-up
\olimport[\olpath/content-new/first-order-logic/natural-deduction]{quantifier-rules}

\olimport*[first-order-logic/natural-deduction]{proving-things-quant}

% Adding Quantifier-Negation derived rules
\olimport[\olpath/content-new/first-order-logic/natural-deduction]{derived-quantifier-rules}
