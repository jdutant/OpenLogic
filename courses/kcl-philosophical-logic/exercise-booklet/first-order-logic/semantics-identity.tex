...
\begin{enumerate}
	...
	\lforall[x'] ( \Atom{\Obj F}{x'} \rightarrow (\eq[x'][x] \lor \eq[x'][y] \lor \eq[x'][z])))$\\
...
(Recall that $y$ is free for $x$ in $!A$ if none of the free occurrences of $x$ in $!A$ are in the scope of a $\lexists[y]$ or $\lexists[x]$ quantifier and $\Subst{!A}{y}{x}$ stands for the !!{formula} resulting from substituting $y$ for all free occurrences of $x$ in $!A$.) Answer the following.
\begin{enumerate}
