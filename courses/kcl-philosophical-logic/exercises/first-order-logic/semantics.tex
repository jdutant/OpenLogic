...
\begin{ans}
\begin{enumerate}
	\item !!^{structure} for truth. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1\}$ and $\Assign{G}{M}=\{1\}$, $\Assign{F}{M}=\varnothing$.\\
	!!^{structure} for falsehood. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1\}$ and $\Assign{G}{M}=\Assign{F}{M}=\varnothing$.
	\item !!^{structure} for truth. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1\}$ and $\Assign{G}{M}=\varnothing$. Another !!{structure} for truth: $\Domain{M}=\{1\}$ and $\Assign{G}{M}=\{\langle 1,1\rangle\}$.\\
	!!^{structure} for falsehood. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1,2\}$ and $\Assign{G}{M}=\{\langle 1,2\rangle\}$.
	\item !!^{structure} for truth. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1\}$ and $\Assign{F}{M}=\Assign{G}{M}=\varnothing$. 
	Another structure for truth: $\Domain{M}=\{1\}$ and $\Assign{F}{M}=\{1\}$ and $\Assign{F}{M}=\varnothing$.\\
	!!^{structure} for falsehood. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1,2\}$ with $\Assign{F}{M}=\{1\}$ 
	and $\Assign{G}{M}=\varnothing$. 
	\item !!^{structure} for truth. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1\}$ and $\Assign{L}{M}=\varnothing$. \emph{Comment: in that structure, $\Atom{\Obj L}{x,y}$ is false relative to any assignment, so $\lexists x \Atom{\Obj L}{x,y}$ is false relative to some assignments, so the antecedent is false and the entire formula true.} Another structure for truth: $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	...
	!!^{structure} for falsehood. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$
	with $\Domain{M}=\{1,2\}$ and $\Assign{L}{M}=\{\langle 1,1 \rangle, 
	\langle 2,2 \rangle\}$. Another structure for falsehood: $\Domain{M}=\{1,2\}$ and $\Assign{L}{M}=\{\langle 1,2 \rangle, 
	\langle 2,1 \rangle\}$.
	\item !!^{structure} for truth. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$ with $\Domain{M}=\{1\}$ and $\Assign{L}{M}=\varnothing$. 
	\emph{Comment: in that structure, $\Atom{\Obj L}{x,y}$ is false relative to any assignment, so $\Atom{\Obj L}{x,y} \rightarrow (\Atom{\Obj L}{y,z} \rightarrow \Atom{\Obj L}{x,z})$ is true relative to any assignment.} Another structure for truth: $\Domain{M}=\{1,2\}$ and $\Assign{L}{M}=\{\langle 1,2 \rangle \}$. Another 
	structure for truth: $\Domain{M}=\{1,2\}$ and $\Assign{L}{M}=\{\langle 1,2 \rangle, \langle 2,2 \rangle \}$.\\
	!!^{structure} for falsehood. $\Struct{M}=\langle\Domain{M},\AssignSimple{M}\rangle$ with $\Domain{M}=\{1,2,3\}$ and $\Assign{L}{M}=\{\langle 1,2 \rangle, \langle 2,3 \rangle \}$. \emph{Comment: relative to the assignement of $1$ to
	$x$, $2$ to $y$ and $3$ to $z$, the embedded formula is false.}
\end{enumerate}
\end{ans}
\end{prob}
